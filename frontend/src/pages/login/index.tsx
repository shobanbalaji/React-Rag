          ...
          <form onSubmit={handleSubmit} className="form-section">
            ...
            <div className="form-group">
              <div className="label-row">
                ...
                <Link to="/login3" className="forgot-link">
                  Forgot Password?
                </Link>
              </div>
            ...
            <Button type="submit" className="btn-primary" disabled={loading}> {loading && <Spinner size="sm" className="mx-1"/> }Login</Button>
      ...
      <div className="login-right">
        ...
        <div className="right-content">
          <div className="stats-highlight">
            ...
            <h3>10,000+</h3>
            <p>Active Students Learning Daily</p>
          </div>
